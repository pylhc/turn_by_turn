...
Also changed the optional xsuite dependancy for to xsuite >= 0.54.6 when not on windows, as now we need the full `xsuite` package for anything related to `xtrack`.
